void setupSSDP() 
{
  ...
  String myIP = WiFi.localIP().toString();
    ssdp_cfg ssdpcfg = {
      ...
      /* description      */  "uSEMP example2 Request extra energy during the night to get the SHM to charge battery to higher level",
      /* modelNr          */  "0.1",
      /* modelURL         */  "http://www.vendor.local/SSDPbasic01",

  
      /* manufacturer     */  "vendor.local",
      /* manufacturererURL*/  "http://www.vendor.local/model",
